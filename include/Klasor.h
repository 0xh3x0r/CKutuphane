...
public: bool Cevir(string strveri)
{
	...
	if((Satýr.compare(0,2,"k;") == 0))
	{
		...
		index_satir = KelimeArasý("ad:",";",Satýr,KlasorAdi,index_satir);
	    if(index_satir == -1)
        return false;
		KlasorAdlari.push_back(KlasorAdi);

		string KlasorOzellik = "";
		index_satir = KelimeArasý("ozlk:",";",Satýr,KlasorOzellik,index_satir);
	    if(index_satir == -1)
        return false;
		KlasorOzellikleri.push_back(str_ulong(KlasorOzellik));

		string KlasorBoyut = "";
		index_satir = KelimeArasý("byt:",";",Satýr,KlasorBoyut,index_satir);
	    if(index_satir == -1)
        return false;		
		KlasorBoyutlari.push_back(str_ulong(KlasorBoyut));

		string KlasorOlusturmaTarihiHigh = "";
		index_satir = KelimeArasý("otrh:","|",Satýr,KlasorOlusturmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,KlasorOlusturmaTarihiLow,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("sytrh:","|",Satýr,KlasorSonYazmaTarihiHigh,index_satir);
        if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,KlasorSonYazmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;
		...
		index_satir = KelimeArasý("setrh:","|",Satýr,KlasorSonErisimTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,KlasorSonErisimTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;
	...
	else if((Satýr.compare(0,2,"d;") == 0))
	{
		...
		index_satir = KelimeArasý("ad:",";",Satýr,DosyaAdi,index_satir);
		if(index_satir == -1)
        return false;
		DosyaAdlari.push_back(DosyaAdi);

		string DosyaOzellik = "";
		index_satir = KelimeArasý("ozlk:",";",Satýr,DosyaOzellik,index_satir);
	    if(index_satir == -1)
        return false;
		DosyaOzellikleri.push_back(str_ulong(DosyaOzellik));

		string DosyaBoyut = "";
		index_satir = KelimeArasý("byt:",";",Satýr,DosyaBoyut,index_satir);
	    if(index_satir == -1)
        return false;
		DosyaBoyutlari.push_back(str_ulong(DosyaBoyut));

		string DosyaOlusturmaTarihiHigh = "";
		index_satir = KelimeArasý("otrh:","|",Satýr,DosyaOlusturmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,DosyaOlusturmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;
		...
		index_satir = KelimeArasý("sytrh:","|",Satýr,DosyaSonYazmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,DosyaSonYazmaTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;
		...
		index_satir = KelimeArasý("setrh:","|",Satýr,DosyaSonErisimTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;		
		...
		index_satir = KelimeArasý("|",";",Satýr,DosyaSonErisimTarihiHigh,index_satir);
	    if(index_satir == -1)
        return false;
...
public: bool Cevir(VolumeString strveri)
{
	...
	int satir_index = 0;
	string sVolumeAdi="";
	satir_index = KelimeArasý("ad:",";",Satýr,sVolumeAdi,satir_index);
	if(satir_index == -1)
		return false;
	VolumeAdlari.push_back(sVolumeAdi);

    string sVolumeBoyut = "";
		satir_index = KelimeArasý("byt:",";",Satýr,sVolumeBoyut,satir_index);
	if(satir_index == -1)
		return false;
	VolumeBoyut.push_back(str_uint64(sVolumeBoyut));

	string sVolumeBosAlan = "";
		satir_index = KelimeArasý("kbyt:",";",Satýr,sVolumeBosAlan,satir_index);
	if(satir_index == -1)
		return false;
	VolumeBosAlan.push_back(str_uint64(sVolumeBosAlan));

	string sVolumeOzellik = "";
		satir_index = KelimeArasý("ozlk:",";",Satýr,sVolumeOzellik,satir_index);
	if(satir_index == -1)
		return false;
	VolumeOzellikleri.push_back(str_ulong(sVolumeOzellik));

	string sVolumePath = "";
		satir_index = KelimeArasý("pth:",";",Satýr,sVolumePath,satir_index);
	if(satir_index == -1)
		return false;
