========================================================================
    STATIC LIBRARY : DinamikDlg Project Overview
========================================================================

AppWizard has created this DinamikDlg library project for you.

This file contains a summary of what you will find in each of the files that
make up your DinamikDlg application.
...
StdAfx.h, StdAfx.cpp
    ...
    named DinamikDlg.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "DinamikDlg.rc" and a "DinamikDlg.h" that
