========================================================================
    STATIC LIBRARY : MesajDlg Project Overview
========================================================================

AppWizard has created this MesajDlg library project for you.

This file contains a summary of what you will find in each of the files that
make up your MesajDlg application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MesajDlg.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MesajDlg.rc" and a "MesajDlg.h" that
