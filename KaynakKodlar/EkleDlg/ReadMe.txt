========================================================================
    STATIC LIBRARY : EkleDlg Project Overview
========================================================================

AppWizard has created this EkleDlg library project for you.

This file contains a summary of what you will find in each of the files that
make up your EkleDlg application.
...
StdAfx.h, StdAfx.cpp
    ...
    named EkleDlg.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "EkleDlg.rc" and a "EkleDlg.h" that
